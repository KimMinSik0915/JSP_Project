...
public class MessageDeleteService implements Service {
	...
	public MessageDeleteService() {
		...
		System.out.println("MessageDeleteService.MessageDeleteService() : 생성완료");		// 서버가 시작될 떄 확인 안나올때 Init.init() 확인해보기
	...
	public Object service(Object obj) throws Exception {
		...
		return dao.delete((long) obj);	// dao.write()실행 후 결과를 리턴해 준다.
