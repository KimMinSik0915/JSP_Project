...
System.out.println(strPerPageNum);
...
// 		alert("click");
	...
	// 한 체이지에 보여주는 데이터 선택에 이벤트 처리 : data값이 변경이 일어나면 처리를 한다
	$("#sel_perPageNum").change(function () {
		
		//alert("값 변경");
		
		// 다시 리스트 불러오기 : perPageNum을 선택된 값을 전달해 준다.
		 ...
		 <div class="row">
		 	<c:forEach items="${list }" var="vo" varStatus="vs">
		 		<c:if test="${(vs.index > 0) && (vs.index % 4 == 0)}">
		 		 <!-- 인덱스가 0 이상이고 4의 배수이면 한 줄(class="dataRow")을 만든다 -->
			  ...
			  <div class="col-md-3 dataRow">
			    <div class="thumbnail">
			        <img src="${path }${vo.fileName}" alt="Lights" style="width:80%; ">  
			        <div class="caption">
